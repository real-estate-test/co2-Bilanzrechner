...
-- Firmenweites Adressbuch: Personen, die an Projekten mitwirken.
-- Das Projekt hält nur, WER beteiligt ist; Name und Mailadresse stehen
-- hier, damit eine Änderung überall gilt.
insert into einstellungen (schluessel, wert) values
  ('adressen', '[]'::jsonb)
on conflict (schluessel) do nothing;

-- Sitzungsreihen für die Protokolle. Jede Reihe zählt ihre Sitzungen
-- je Projekt für sich.
insert into einstellungen (schluessel, wert) values
  ('sitzungsreihen', '[
